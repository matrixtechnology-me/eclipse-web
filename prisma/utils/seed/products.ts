  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Vestido leve e colorido com estampa floral, ideal para passeios e festas. Tecido macio que garante conforto durante todo o dia.",
        active: true,
      ...
      },
      {
        ...
        description: "Sandália com tiras ajustáveis e detalhe brilhante, perfeita para passeios em dias quentes. Solado antiderrapante.",
        active: true,
        ...
        categoryId: "85376591-0e1e-4770-b640-25ee7aedccbf",
        subcategoryId: "9e52d5ad-3f84-4c71-8e5a-4ef9a3ec8c4d",
      },
      {
        id: "b9e1c2d3-4f5a-6789-8b1c-2d3e4f5a6789",
        name: "Blocos de Montar Criativos 120 peças",
        description: "Kit de blocos de montar coloridos que estimulam a imaginação e a criatividade das crianças, ideal para brincadeiras educativas.",
        active: true,
      ...
      },
      {
        ...
        internalCode: "pat004",
        categoryId: "61b93de2-afaf-4cfb-9abb-f0bcb60c43be",
        subcategoryId: "c2f8e1b6-0dc1-41b9-9952-098b5e23df47",
      }
    ],
  });
}